			...
			<View style={styles.cardsContainer}>
				...
				>
					<View style={styles.cardContent}>
						...
						<Text style={styles.cardDescription}>
							This set covers the Manifest Destiny
						</Text>
					</View>
				...
				>
					<View style={styles.cardContent}>
						<Text style={styles.cardTitle}>US History</Text>
						<Text style={styles.cardDescription}>
							This set covers the founding of America.
						</Text>
					</View>
					<Text style={styles.cardUpdated}>Last updated: Now</Text>
				</TouchableOpacity>
				...
				<View style={styles.card}>
					<View style={styles.cardContent}>
						...
						<Text style={styles.cardDescription}>
							This set covers laws of motion and energy.
						</Text>
					</View>
				...
				<View style={styles.card}>
					<View style={styles.cardContent}>
						...
						<Text style={styles.cardDescription}>
							This set covers the periodic table and chemical
							reactions.
						</Text>
					</View>
					<Text style={styles.cardUpdated}>
